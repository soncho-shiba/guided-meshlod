...
namespace Jp.Local.GuidedMeshLod.Tests
{
    ...
    public sealed class MeshLodBuilderTests
    {
        ...
        // ---- BuildParams バリデーション（早めにテスト、U-07 として詳細は Phase 5 で） ----

        [Test]
        public void Build_ValidateInput_throws_when_lodCount_out_of_range()
        {
        ...
        [Test]
        public void Build_ValidateInput_throws_when_targetRatios_not_decreasing()
        {
            var src = MakeMultiSubmesh(30, 1);
            var settings = MakeSettings();
            var parameters = new BuildParams
        ...
        [Test]
        public void Build_ValidateInput_throws_when_mesh_not_readable()
        {
            // 動的に作った mesh は isReadable=true なので、null mesh で異常系の代理確認
